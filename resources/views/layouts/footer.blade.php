        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 pt-12">
                ...
                <div class="flex justify-center items-center space-x-6 mb-12">
                    <a href="#" class="w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition">
                    ...
                    <a href="#" class="w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.161c.18.717.28 1.528.28 2.362 0 4.089-3.11 8.809-8.809 8.809-1.75 0-3.377-.514-4.749-1.396.242.029.488.042.739.042 1.448 0 2.779-.494 3.841-1.323-1.352-.025-2.494-.918-2.887-2.144.189.036.383.055.583.055.283 0 .558-.038.818-.109-1.413-.283-2.478-1.531-2.478-3.029v-.039c.416.231.892.369 1.399.386-.828-.553-1.374-1.497-1.374-2.567 0-.566.152-1.095.418-1.551 1.524 1.869 3.802 3.098 6.371 3.227-.052-.224-.079-.457-.079-.697 0-1.69 1.37-3.061 3.061-3.061.881 0 1.676.372 2.234.966.697-.137 1.353-.391 1.943-.742-.228.713-.713 1.312-1.345 1.689.619-.074 1.208-.238 1.756-.481-.411.614-.931 1.152-1.529 1.584z"/></svg>
                    </a>
                </div>
